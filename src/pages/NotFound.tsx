  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-24 sm:px-6 lg:px-8 md:py-32">
      <div className="max-w-xl">
        ...
        <Link
          to="/"
          className="mt-8 inline-block rounded-md border border-border bg-white px-5 py-2.5 text-sm font-medium text-foreground transition-colors duration-150 hover:bg-neutral-50 hover:border-neutral-300"
        >
          Back to home
        </Link>
      </div>
